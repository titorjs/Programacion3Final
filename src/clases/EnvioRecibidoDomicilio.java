...
public class EnvioRecibidoDomicilio extends Envio{
    ...
    public EnvioRecibidoDomicilio(int id, int estado, Date fechaRecibido, Persona solicitante, Persona receptor, Paquete paquete, Sucursal sucursalRecibida, Sucursal sucursalEntrega, Direccion direccionEntrega, Direccion direccionRecibida) {
